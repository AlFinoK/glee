  ...
  return (
    <section className={s.team}>
      <div className="container">
        <div className={s.team__inner}>
          <div className={s.team__info}>
            <h4 className={s.team__infoTitle}>Our Team</h4>
            <p className={s.team__infoText}>
            ...
            <Link className={s.team__infoLink} to="https://t.me/nikita_rudenko">
              Join With US
          ...
          <div className={s.team__employ}>
            <div className={s.team__employItem}>
              <img
                className={s.team__employImg}
                src="https://gleefilesbucket.s3.eu-central-1.amazonaws.com/images-glee/content/about/employ-1.jpg"
                alt="employ"
              />
              <div className={s.team__employInfo}>
                <div className={s.team__employNames}>
                  <h6 className={s.team__employName}>Eliza Elliot</h6>
                  <p className={s.team__employJob}>Commodo tempor</p>
                </div>
                <div className={s.team__employLinks}>
                  <Link
                    className={`${s.team__employSocial} ${s.inst}`}
                    to="https://t.me/nikita_rudenko">
                    <svg
                  ...
                  <Link
                    className={`${s.team__employSocial} ${s.google}`}
                    to="https://t.me/nikita_rudenko">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="23"
            ...
            <div className={s.team__employItem}>
              ...
              <div className={s.team__employInfo}>
                <div className={s.team__employNames}>
                  <h6 className={s.team__employName}>Roscoe A.</h6>
                  <p className={s.team__employJob}>Commodo tempor</p>
                </div>
                <div className={s.team__employLinks}>
                  <Link
            ...
            <div className={s.team__employItem}>
              ...
              <div className={s.team__employInfo}>
                <div className={s.team__employNames}>
                  <h6 className={s.team__employName}>Ruby M.</h6>
                  <p className={s.team__employJob}>Commodo tempor</p>
                </div>
                <div className={s.team__employLinks}>
                  <Link
            ...
            <div className={s.team__employItem}>
              ...
              <div className={s.team__employInfo}>
                <div className={s.team__employNames}>
                  <h6 className={s.team__employName}>Marie F. Bloss</h6>
                  <p className={s.team__employJob}>Commodo tempor</p>
                </div>
                <div className={s.team__employLinks}>
                  <Link
