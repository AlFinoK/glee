...
const MainProductBlock = ({ title, price, imageUrl }) => {
  return (
    <div className="product__content-item">
      <div className="product__content-images">
        <img className="product__content-img" src={imageUrl} alt="1" />
        <div className="product__content-links">
          <Link className="product__content-link" to="/">
      ...
      <h6 className="product__content-title">{title}</h6>
      <span className="product__content-price">${price}</span>
    </div>
  )
}

export default MainProductBlock
