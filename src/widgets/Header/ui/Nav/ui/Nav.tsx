  ...
  return (
    <nav className={s.menu}>
      <Link className={s.menu__logo} to="/">
        <img className={s.menu__logoImg} src={logoSvg} alt="logo" />
        <span>Glee.</span>
      </Link>
      <MenuList />
      <div className={s.menu__icons}>
        <div className={s.menu__search}>
          <input className={s.menu__input} placeholder="What are you looking for?" />
        ...
        <div className={s.menu__iconsBox}>
          <button className={s.menu__iconBox} onClick={() => plusNumber()}>
            ...
            <span className={s.menu__iconNumber}>{cash}</span>
          </button>
          <button className={s.menu__iconBox} onClick={() => minusNumber()}>
            <svg
              className={s.favoriveActive}
      ...
      {/* <div className={s.menu__user}>
        <Link className={s.menu__userLink} to="/login">
